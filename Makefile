...
app: src/jsonxx/jsonxx.o src/signalhandler.o src/couchdb.o  src/main.o
	$(CC) $(CPPFLAGS) $(CFLAGS) -o couchdb src/jsonxx/jsonxx.o src/signalhandler.o src/couchdb.o  src/main.o $(LDLIBS)
